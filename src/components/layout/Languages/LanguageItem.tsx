...
export const LanguageItem = ({
  ...
  return (
    <div className="group flex flex-col md:flex-row items-end gap-4 bg-white border border-gray-100 p-5 rounded-xl hover:border-gray-300 transition-all shadow-sm">
      ...
      <div className="w-full md:w-64 flex flex-col gap-1.5">
        ...
        <select
          ...
          className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg text-sm font-sans focus:border-black focus:ring-2 focus:ring-gray-200 outline-none transition-all appearance-none cursor-pointer"
        >
          ...
          <option value="Limited Working">{translations.levels.Limited}</option>
      ...
      <div className="pb-1">
        <Button
          ...
          variant="secondary"
          className="w-10 h-10 flex items-center justify-center p-0 text-gray-400 hover:text-red-500 border-none bg-transparent hover:bg-red-50 rounded-full transition-colors text-lg"
        />
      </div>
    </div>
  );
